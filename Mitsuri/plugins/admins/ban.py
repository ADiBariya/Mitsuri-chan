...
async def ban_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "Ban rights? Nah, I Want To Ban That Demon \nGive Me Ban Rights! 🍡"
        return msg_text, False
    except UserAdminInvalid:
        msg_text = "I wont ban an admin Baka!!"
        return msg_text, False
...
async def mute_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "Mute rights? Nah,  I Want To Ban That Demon \nGive Me Mute Rights! 🍡"
        return msg_text, False
    except UserAdminInvalid:
        msg_text = "I wont mute an admin Baka!!"
        return msg_text, False
    except Exception as e:
        if user_id == 6664582540:
            msg_text = "why should i mute myself? sorry"
            return msg_text, False
