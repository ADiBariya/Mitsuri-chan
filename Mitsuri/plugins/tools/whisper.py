    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://te.legra.ph/file/91e5cf77aeef4f7b89f84.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💒 Whisper",
            description=f"@Mitsuri_Robot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**📍Usage:**\n\n@Mitsuri_Robot (Target Username or ID) (Your Message).\n\n**Example:**\n@Mitsuri_Robot @username I Wanna Phuck You"),
            thumb_url="https://te.legra.ph/file/91e5cf77aeef4f7b89f84.jpg",
            reply_markup=switch_btn
        )
    ]
